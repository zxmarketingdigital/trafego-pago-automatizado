...
def cmd_renew():
    ...
    print("4. Selecione o app e marque as permissões:")
    print("     ✓ ads_management")
    print("     ✓ ads_read")
    print("     ✓ business_management")
    print()
    print("   ⚠️  NAO TEM NENHUM APP PRA SELECIONAR?")
    print("   Isso e normal se voce nunca criou um. A Meta exige um app")
    print("   vinculado ao Business pra emitir System User Token. Faca uma vez:")
    print("     a) developers.facebook.com > criar app do tipo 'Negocios/Business'")
    print("     b) associe esse app a sua conta de Business Manager")
    print("     c) no Business Manager, de ao System User acesso ao app E")
    print("        a conta de anuncios (atribuir ativos)")
    print("   Depois volte ao passo 3 — o app ja vai aparecer na lista.")
    print()
    ...
    if not ok:
        ...
        print("   Se o erro for Graph API 403 (Forbidden): o token existe mas nao tem")
        print("   autorizacao pra conta de anuncios. Confira (1) se ads_management e")
        print("   ads_read foram marcadas ao gerar o token e (2) se a CONTA DE ANUNCIOS")
        print("   esta atribuida ao System User como ativo no Business Manager.")
        return 3
